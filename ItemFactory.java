public class ItemFactory {
  ...
  public static Item createAntibiotics() {
  ...
  public static Item createTickTest() {
  ...
  public static Item createCheapMeds() {
  ...
  public static Item createOldRod() {
    Item oldRod = new Item("Old rod", "This fishing rod looks ok.", true,
    OLD_ROD_STREETCRED_COST, OLD_ROD_WORKCRED_COST, 0, OLD_ROD_FISHING_SKILL_GAIN, 0);
    return oldRod;
  }

  public static Item createGoodRod() {
  ...
  public static Item createSuperRod() {
    Item superRod = new Item("Super rod", "This fishing rod is even better than a great rod!", true,
    SUPER_ROD_STREETCRED_COST, SUPER_ROD_WORKCRED_COST, 0, SUPER_ROD_FISHING_SKILL_GAIN, 0);
    return superRod;
  }

  public static Item createGreatRod() {
  ...
  public static Item createHyperRod() {
  ...
  public static Item createMasterRod() {
  ...
  public static Item createBasicGear() {
  ...
  public static Item createDecentGear() {
  ...
  public static Item createExcellentGear() {
  ...
  public static Item createPhenomenalGear() {
  ...
  public static Item createMasterGear() {
